...
Please feel free to open issues if you find bugs, have questions or suggestions. Feedback is very welcome!
...
Run the __Jupyter notebooks__ in the `notebooks` directory to get familiar with the syntax and data structures for both input and output.
