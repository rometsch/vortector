...
def show_fit_overview_2D(vt, n=None, fig=None, bnd_lines=False, bnd_pnts=False, show_fits=True, fit_contours=True, xscale=None, hspace=0.001, wspace=0.001):
    if fig is None:
    ...
    show_fit_overview_2D_single(vt, "vortensity", ax=axes[1, 0], n=n,
                                ...
                                show_fits=show_fits,
                                cbar_axes=[axes[1, 0], axes[1, 1]], cmap="magma_r")
...
def show_fit_overview_2D_single(vt, varname, ax, n=None, bnd_lines=False,
    ...
    if isinstance(show_fits, bool) and not show_fits:
        show_fits = []
    ...
    for n, vort in enumerate(vortices):
        ...
        if show_fits == True or "vortensity" in show_fits:
            try:
        ...
        if show_fits == True or "surface_density" in show_fits:
            try:
